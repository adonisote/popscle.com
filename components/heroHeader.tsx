  ...
  return (
    <>
      <div className='py-8 px-4 mx-auto max-w-screen-lg text-center lg:py-16 lg:px-12 animate-in'>
        ...
        <div
          className='absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-[40px] opacity-60 sm:top-[calc(100%-30rem)] animate-blob-landing'
          aria-hidden='true'
        >
          <div
            className='relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#F473B6] to-[#9089fc] opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem] mix-blend-multiply'
            style={{
              clipPath:
        ...
        {/* <Button className='px-10'>Join the waitlist</Button> */}
      </div>
    </>
  );
}
